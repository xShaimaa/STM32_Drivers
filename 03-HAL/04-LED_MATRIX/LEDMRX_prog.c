...
u8 LEDMRX_ROWS_PORT[8] = {LEDMRX_ROW0_PORT, LEDMRX_ROW1_PORT, LEDMRX_ROW2_PORT, LEDMRX_ROW3_PORT, LEDMRX_ROW4_PORT, LEDMRX_ROW5_PORT, LEDMRX_ROW6_PORT, LEDMRX_ROW7_PORT};
u8 LEDMRX_ROWS_PINS[8] = {LEDMRX_ROW0_PIN, LEDMRX_ROW1_PIN, LEDMRX_ROW2_PIN, LEDMRX_ROW3_PIN, LEDMRX_ROW4_PIN, LEDMRX_ROW5_PIN, LEDMRX_ROW6_PIN, LEDMRX_ROW7_PIN};

/* arrays to hold the PORT and PIN of the columns */
u8 LEDMRX_COLS_PORT[8] = {LEDMRX_COL0_PORT, LEDMRX_COL1_PORT, LEDMRX_COL2_PORT, LEDMRX_COL3_PORT, LEDMRX_COL4_PORT, LEDMRX_COL5_PORT, LEDMRX_COL6_PORT, LEDMRX_COL7_PORT};
u8 LEDMRX_COLS_PINS[8] = {LEDMRX_COL0_PIN, LEDMRX_COL1_PIN, LEDMRX_COL2_PIN, LEDMRX_COL3_PIN, LEDMRX_COL4_PIN, LEDMRX_COL5_PIN, LEDMRX_COL6_PIN, LEDMRX_COL7_PIN};
